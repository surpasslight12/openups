# OpenUPS - 文档索引# OpenUPS - 文档目录



本目录包含 OpenUPS 项目的技术深度文档。本目录包含 OpenUPS 项目的所有技术文档。
...
1. **[../README.md](../README.md)** - 项目主页，了解项目特性- **[ARCHITECTURE.md](ARCHITECTURE.md)** - 项目架构设计

2. **[../QUICKSTART.md](../QUICKSTART.md)** - 5 分钟快速上手  - 模块结构和职责

3. **[ARCHITECTURE.md](ARCHITECTURE.md)** - 深入理解架构（可选）  - 数据流和交互

  - 核心算法和实现

### 📖 根目录文档（用户导向）  

- **[README.md](../README.md)** - 项目主页和特性介绍- **[PROJECT_STATUS.md](PROJECT_STATUS.md)** - 项目状态报告

- **[QUICKSTART.md](../QUICKSTART.md)** - 快速上手和常用场景  - 完整的项目概览

- **[CONTRIBUTING.md](../CONTRIBUTING.md)** - 贡献指南（开发者）  - v1.1.0 更新摘要

- **[CHANGELOG.md](../CHANGELOG.md)** - 版本更新日志  - 配置系统说明

  - 性能指标和测试状态

### 🏗️ 技术文档（docs/ 目录）  - 版本路线图

- **[ARCHITECTURE.md](ARCHITECTURE.md)** - 架构设计详解

  - 模块化设计和职责### 临时报告

  - 依赖关系和数据流`reports/` 目录包含临时生成的报告文件：
...
- **DEPLOYMENT.md** - 部署和运维指南 🚧 计划中- 项目清单

  - 生产环境部署

  - systemd 服务配置详解**注意**: `reports/` 目录已加入 `.gitignore`，不会提交到 Git 仓库。
...
- **DEVELOPMENT.md** - 开发者详细指南 🚧 计划中项目根目录的用户文档：

  - 完整开发环境配置- **[README.md](../README.md)** - 项目入口文档

  - 代码结构详解- **[QUICKSTART.md](../QUICKSTART.md)** - 快速开始指南

  - 调试技巧和性能分析- **[CONTRIBUTING.md](../CONTRIBUTING.md)** - 贡献指南

  - 测试框架使用- **[CHANGELOG.md](../CHANGELOG.md)** - 版本变更历史
...
- **[../.cursorrules](../.cursorrules)** - Cursor AI 编码规范1. 技术文档更新在本目录（`docs/`）
